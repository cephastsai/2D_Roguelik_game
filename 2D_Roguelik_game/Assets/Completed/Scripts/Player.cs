...
namespace Completed
{
	...
	public class Player : MovingObject
	{
		...
		{
            level = PlayerPrefs.GetInt("level", level) - 1;
		...
		private void OnDisable ()
		{
            ...
            GameManager.instance.playerMaxFoodPoint = maxFood;
		}
		...
		protected override void AttemptMove <T> (int xDir, int yDir)
		{
			...
			if(Newhand.isPlayerCantMove) return;
		...
		private void OnTriggerEnter2D (Collider2D other)
		{
			...
			if(other.tag == "Exit")
			{
				...
				if(GameObject.Find("Text_BG").GetComponent<Newhand>().ExitOn){

					if(GameObject.Find("GameManager(Clone)").GetComponent<Completed.GameManager>().getlevel() == 10){
						GameObject.Find("Exit(Clone)").GetComponent<EndExit>().EndingExit();
					}else{
